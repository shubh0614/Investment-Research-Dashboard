    ...
    <div style={{ position: "relative", minHeight: "100%", color: "var(--text)" }}>
      <div style={{ position: "relative", zIndex: 1, maxWidth: 560, margin: "0 auto", padding: "48px 32px 32px" }}>
        ...
        <div style={{ marginBottom: 36, textAlign: "center" }}>
          <h1
            style={{
              fontSize: 28, fontWeight: 700, letterSpacing: "-0.022em", lineHeight: 1.2,
        ...
        <form onSubmit={handleSubmit} className="reveal">
          <div className={running ? "ai-thinking-wrap" : ""} style={running ? { borderRadius: 14 } : {}}>
            <div style={{ borderRadius: 14, border: running ? "none" : "1px solid var(--border)", background: "var(--surface-1)", overflow: "hidden", boxShadow: "0 4px 24px rgba(12,11,10,.15)" }}>
              <textarea
                value={query}
        ...
        {/* Error state */}
        {phase.step === "error" && (
          <div className="reveal" style={{ marginTop: 12, borderRadius: 8, padding: "12px 16px", background: "color-mix(in srgb, var(--neg) 8%, transparent)", border: "1px solid color-mix(in srgb, var(--neg) 25%, transparent)" }}>
            <p style={{ fontSize: 13, fontWeight: 500, color: "var(--neg)" }}>Research failed</p>
          ...
          <div style={{ marginTop: 32 }} className="stagger">
            ...
            {EXAMPLES.map((ex) => (
              <button
                ...
                style={{ display: "flex", width: "100%", alignItems: "flex-start", gap: 12, borderRadius: 6, padding: "11px 14px", marginBottom: 8, textAlign: "left", border: "none", cursor: "pointer" }}
              >
