export default function ReportLoading() {
  return (
    <div className="mx-auto w-full max-w-4xl px-8 py-10">
      ...
      <div className="mb-6 rounded-xl border p-6" style={{ background: "var(--surface-1)", border: "1px solid var(--border)" }}>
      ...
      {/* News skeleton */}
      <div className="rounded-xl border p-6" style={{ background: "var(--surface-1)", border: "1px solid var(--border)" }}>
