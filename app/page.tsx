    ...
    <div style={{ background: "var(--bg)", color: "var(--text)", minHeight: "100dvh" }}>
      ...
      <style>{`
        @media (max-width: 768px) {
          .lp-nav-inner { padding-left: 16px !important; padding-right: 16px !important; }
          .lp-nav-links { display: none !important; }
          .lp-hero-section { padding: 48px 16px 40px !important; }
          .lp-hero-grid { grid-template-columns: 1fr !important; gap: 32px !important; }
          .lp-hero-mock { display: none !important; }
          .lp-hero-h1 { font-size: 2.1rem !important; }
          .lp-section-inner { padding-left: 16px !important; padding-right: 16px !important; padding-top: 48px !important; padding-bottom: 48px !important; }
          .lp-social-proof { padding-left: 16px !important; padding-right: 16px !important; gap: 16px !important; justify-content: flex-start !important; }
          .lp-3col { grid-template-columns: 1fr !important; }
          .lp-2col { grid-template-columns: 1fr !important; }
          .lp-4col { grid-template-columns: repeat(2, 1fr) !important; gap: 12px !important; }
          .lp-howit-section { padding: 48px 16px !important; }
          .lp-features-section { padding: 48px 16px !important; }
          .lp-trust-section { padding: 48px 16px !important; }
          .lp-cta-section { padding: 56px 16px !important; }
          .lp-footer-inner { padding: 20px 16px !important; }
        }
      `}</style>
      ...
      >
        <div className="lp-nav-inner" style={{ maxWidth: 1100, margin: "0 auto", padding: "0 32px", height: 56, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          {/* Mobile sign-in only */}
          <div className="lp-nav-mobile-signin" style={{ display: "none" }}>
            <style>{`@media (max-width: 768px) { .lp-nav-mobile-signin { display: block !important; } }`}</style>
            <Link href="/login"
              style={{ height: 34, padding: "0 14px", borderRadius: 6, background: "var(--accent)", color: "var(--accent-ink)", fontSize: 13, fontWeight: 600, display: "inline-flex", alignItems: "center", textDecoration: "none" }}>
              Sign in
            </Link>
          </div>
        </div>
      ...
      {/* ── Hero ────────────────────────────────────────────────────────────── */}
      <section className="lp-hero-section" style={{ maxWidth: 1100, margin: "0 auto", padding: "80px 32px 72px" }}>
        <div className="lp-hero-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
          ...
          <div>
            ...
            <h1 className="lp-hero-h1" style={{ fontSize: "3rem", fontWeight: 700, lineHeight: 1.08, letterSpacing: "-0.03em", color: "var(--text)", fontFamily: "var(--font-serif)", marginBottom: 20 }}>
          ...
          <div className="lp-hero-mock" style={{ borderRadius: 10, border: "1px solid var(--border)", background: "var(--surface-1)", overflow: "hidden" }}>
            {/* Mock report header */}
      ...
      <section style={{ borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)", padding: "20px 32px" }}>
        <div className="lp-social-proof" style={{ maxWidth: 1100, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "center", gap: 40, flexWrap: "wrap" }}>
      ...
      {/* ── Problem ─────────────────────────────────────────────────────────── */}
      <section>
        <div className="lp-section-inner" style={{ maxWidth: 1100, margin: "0 auto", padding: "80px 32px" }}>
      ...
      {/* ── How it works ────────────────────────────────────────────────────── */}
      <section id="how-it-works" className="lp-howit-section" style={{ background: "var(--surface-1)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)", padding: "72px 32px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div className="lp-3col" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 32 }}>
            {[
              {
                n: "01",
      ...
      <section id="output-showcase">
        <div className="lp-section-inner" style={{ maxWidth: 1100, margin: "0 auto", padding: "80px 32px" }}>
          ...
          <div className="lp-2col" style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 16 }}>
            {[
      ...
      {/* ── Features ────────────────────────────────────────────────────────── */}
      <section id="features" className="lp-features-section" style={{ background: "var(--surface-1)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)", padding: "72px 32px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          <p style={{ fontSize: 11, fontFamily: "var(--font-mono)", textTransform: "uppercase", letterSpacing: "0.1em", color: "var(--accent)", marginBottom: 12, textAlign: "center" }}>
            Features
          </p>
          ...
          <div className="lp-4col" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 24 }}>
            {[
      ...
      {/* ── Trust ───────────────────────────────────────────────────────────── */}
      <section className="lp-trust-section" style={{ padding: "80px 32px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
      ...
      {/* ── Final CTA ───────────────────────────────────────────────────────── */}
      <section className="lp-cta-section" style={{ borderTop: "1px solid var(--border)", padding: "72px 32px", textAlign: "center" }}>
      ...
      <footer style={{ borderTop: "1px solid var(--border)" }}>
        <div className="lp-footer-inner" style={{ maxWidth: 1100, margin: "0 auto", padding: "24px 32px", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
